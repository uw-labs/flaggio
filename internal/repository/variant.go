...
type Variant interface {
	...
	Create(ctx context.Context, flagID string, input flaggio.NewVariant) (*flaggio.Variant, error)
	// Update updates a variant under a flag.
	Update(ctx context.Context, flagID, id string, input flaggio.UpdateVariant) (*flaggio.Variant, error)
